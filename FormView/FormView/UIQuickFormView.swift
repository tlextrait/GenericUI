...
//
/*
public protocol InputProtocol : class {
    associatedtype OutputType
    var outputValue: OutputType? { get }
}
*/
...
//
/*
extension UITextField : InputProtocol {
    public var outputValue: Any? { return text as Any }
}

extension UISwitch : InputProtocol {
    public var outputValue: Any? { return isOn as Any }
}

extension UISegmentedControl : InputProtocol {
    public var outputValue: Any? { return selectedSegmentIndex as Any }
}

extension UISlider : InputProtocol {
    public var outputValue: Any? { return value as Any }
}
*/
//
// Quick Form Binding
//
/*
open class UIQuickFormBinding {
    var view: UIView?
    var input: InputProtocol?
    var outputSelector: Selector?
    var size: UInt = 1
    
    var isSpacer: Bool {
        return view == nil && input == nil
    }
    ...
    convenience init(view: UIView, input: InputProtocol, outputSelector: Selector, size: UInt) {
        self.init()
        self.view = view
        self.input = input
    ...
    fileprivate func resolve(_ on: NSObjectProtocol) {
        on.perform(outputSelector, with: input?.outputValue)
    }
}
*/
